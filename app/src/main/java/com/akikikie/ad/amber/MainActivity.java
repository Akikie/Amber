...
//                Toast.makeText(getApplicationContext(),"complet",Toast.LENGTH_SHORT).show();
                str_user = user_text.getText().toString().trim();
                str_pass = pass_text.getText().toString().trim();

                if (str_user.equals("") || str_pass.equals("")) {

                    Toast.makeText(getApplicationContext(),"Error,Something was wrong",Toast.LENGTH_SHORT).show();
